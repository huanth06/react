...
export default function Footer() {
    ...
    return (
        <>
            <footer className="wrapper-footer mt-4">
                <div className="container pt-4">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-8 d-none d-sm-block">
                            <ul className="list-inline d-flex flex-wrap payment-logo" >
                                <li>
                        ...
                        <div class="col-12 col-md-4 text-md-right">
                            <p class="small" data-test-id="address">
                                <strong>Copyright © {currentYear} OCAM.</strong>
                                <br />
                                <strong>ABN:</strong> 22611888914
                            </p>
                        </div>
                    </div>
                </div>
