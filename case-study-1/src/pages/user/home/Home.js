            ...
            <section className="row products-row">
                <article className="col-8 col-sm-6 col-lg-4 col-xl-3 pb-2">
                    <div className="card thumbnail card-body">
                        <Link to="#" className="thumbnail-image pb-2">
                            <img src="https://firebasestorage.googleapis.com/v0/b/c05casestudy.appspot.com/o/files%2FRSTest-1.jpg?alt=media&token=8036fb9e-fe65-4195-87cd-f01abfdb862a" className="product-image img-fluid" alt="product_name" />
                        </Link>
                        <p className="card-title h4 text-center" ><Link to="#">Hasbro Game Night</Link></p>
